      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
        {isAboveMedScreen ? (
          ...
          >
            <img
              alt="profile"
              className="hover:fliter hover:saturate-200 transition duration-500 z-10 w-full
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem consequatur est odit nam veritatis magni blanditiis iure commodi ex, officia, ducimus libero assumenda porro ipsam minima quidem iusto, quisquam explicabo.
          </p>
        </motion.div>
