    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus fugit consequatur itaque quae ullam vel molestias nemo recusandae! Non esse eaque aut. Hic repellendus harum tempore sequi aliquid vel necessitatibus!
          </p>
        </motion.div>
        <motion.div
          className="md:w-1/3 mt-10"
        ...
        >
          <div className="relative h-32">
            <div className="z-10">
              ...
              <p className="font-playfair font-semibold text-3xl mt-3">Innovation</p>
            </div>
          </div>
